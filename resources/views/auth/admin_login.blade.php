...
<div class="text-center my-4">
    <div class="flex items-center justify-center">
        <svg fill="none" viewBox="0 0 24 24" class="w-12 h-12 text-orange-500" stroke="currentColor">
...
<div class="flex justify-center my-2 mx-4 md:mx-0">
    <form class="w-full max-w-xl bg-white rounded-lg shadow-md p-6"  method="POST" action="{{ route('admin.login') }}">
        @csrf
        <div class="flex flex-wrap -mx-3 mb-6">
            <div class="w-full md:w-full px-3 mb-6">
                ...
                <input  id="email" type="email" class="appearance-none block w-full bg-white text-gray-900 font-medium border border-gray-400 rounded-lg py-3 px-3 leading-tight focus:outline-none" name='email' autocomplete  required>
            </div>
            @error('email')
            ...
            <div class="w-full md:w-full px-3 mb-6">
                ...
                <input id="password" type="password" class="appearance-none block w-full bg-white text-gray-900 font-medium border border-gray-400 rounded-lg py-3 px-3 leading-tight focus:outline-none" name="password" required>
            </div>
            @error('password')
            <p class="text-red-500 text-xs italic mt-4">
                {{ $message }}
            ...
            <div class="w-full md:w-full px-3 mb-6">
                <button  type="submit" class="appearance-none block w-full bg-orange-600 text-gray-100 font-bold border border-gray-200 rounded-lg py-3 px-3 leading-tight hover:bg-orange-500 focus:outline-none focus:bg-white focus:border-gray-500">Sign in</button>
            </div>
